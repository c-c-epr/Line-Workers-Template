/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 384be6031769d0ac83e2f7045d02e1f8)
// Runtime types generated with workerd@1.20260611.1 2026-01-28 nodejs_compat
interface __BaseEnv_Env {
	...
	SendmessageWithDelay: Workflow<Parameters<import("./src/_index").SendmessageWithDelay['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/_index");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "timezone" | "LINE_CHANNEL_SECRET" | "LINE_CHANNEL_ACCESS_TOKEN">> {}
}
